...
package body http is
   ...
   --
   --  Read the headers from the request.  This will need to be updated to
   --  return the item being requested and any passed parameters.  Possibly it
   --  will also be necessary to distinguish between GET and POST methods.  Any
   --  other method will trigger a not_implemented_req() response.
   --
